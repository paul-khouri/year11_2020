...
play_again = ""
while play_again == "":
    low = get_user_integer("Please enter a Low number: " , 0,20, "Please an appropriate integer")
    high = get_user_integer("Please enter a Hign number:" , low,200, "Please an appropriate integer")
    print("You have 8 guesses to guess a randomly generated number between {} & {}".format(low,high))
