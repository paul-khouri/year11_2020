...
print("Bill's Diner")
print("-"*40)
print("{:<3}{:<12}at ${:<10.2f}= ${:.2f}".format(mains,"mains", MAIN_PRICE, mains_total))
print("{:<3}{:<12}at ${:<10.2f}= ${:.2f}".format(desserts,"desserts", DESSERT_PRICE, desserts_total))
print("{:<3}{:<12}at ${:<10.2f}= ${:.2f}".format(drinks,"drinks", DRINKS_PRICE, drinks_total))
print("-"*40)
